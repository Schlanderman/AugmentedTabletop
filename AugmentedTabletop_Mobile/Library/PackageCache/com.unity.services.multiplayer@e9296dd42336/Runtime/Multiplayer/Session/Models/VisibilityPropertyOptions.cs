namespace Unity.Services.Multiplayer
{
    ...
    /// <remarks>
    /// <para>
    /// A <see cref="VisibilityPropertyOptions.Public">public</see> property is
    /// visible to everyone and is included in query results.<br/>
    /// A <see cref="VisibilityPropertyOptions.Member">member</see> property is
    /// only visible to the members of the session (in other words, those who
    /// have successfully joined).<br/>
    /// A <see cref="VisibilityPropertyOptions.Private">private</see> property
    /// is only visible to the member who set it. Only the host can set and see
    /// private session properties.
    /// <br/>
    /// For more information, see <a
    /// href="https://docs.unity.com/ugs/en-us/manual/lobby/manual/lobby-data-and-player-data#Data_access_table">data
    /// access table</a>.<br/>
    /// <br/>
